...
<?php    
    ...
    $heroSection = new HeroSection('ibo_Fuell_Beratung_0423.jpg', true, 'top');
    $heroSection->displayHeroSection(); 

    $homeView = new HomeView(); 
    $homeView->displayContent($databaseHandler); 
...
?>
    ...
    <script src="typedContainer.js"></script>
